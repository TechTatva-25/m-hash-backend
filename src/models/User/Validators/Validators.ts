...
export const registerValidator = [
	...
	body("username", "Name must be at least 3 characters long").isLength({
		min: 3,
	}),
	body("username", "Name must be at most 200 characters long").isLength({
		max: 200,
	}),
	body(
		"username",
		"Name must contain only alphanumeric characters, underscores, and spaces",
	).matches(/^[a-zA-Z0-9_ ]+$/),
	...
	body("collegeOther", "Other college name must be string")
		.isString()
		.optional(),
...
export const listUsersValidator = [
	query("limit", "Limit must be a number")
